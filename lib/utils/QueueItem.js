...
var QueueItem = module.exports = function(commandName, method, scope, args) {
    ...
    if( typeof last_arg == 'function' ){
      this.args[this.args.length-1] = function( err, result ){
        ...
        // console.log(self.queue.currentChildIndex + ' done');
        self.queue.next();
      };
    }else{
    ...
    this.run = function (){
      // console.log( 'exec method ' + this.queue.currentChildIndex + ', name = ' + this.commandName );
      this.queue.currentChildIndex++;
    ...
    this.add = function ( item ){
      ...
      // console.log( 'add command ' + item.commandName );
      if( item.commandName === 'end' || item.commandName === 'call' ){
        // console.log( 'next' );
        // console.log( 'index = ' + this.currentChildIndex );
        // console.log( 'total = ' + this.children.length );
        this.next();
      }
    };
